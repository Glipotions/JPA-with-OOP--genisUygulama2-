...
@NamedQueries({
	...
	@NamedQuery(name="User.userInfoByUsername",
				query="SELECT new com.proje.model.UserInfo(u.username, u.userDetail.firstName, u.userDetail.lastName, u.userDetail.date) FROM User u WHERE u.username = :username"),
